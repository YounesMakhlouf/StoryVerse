 ...
 */
final class Version20230506200949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, reply_id INT DEFAULT NULL, story_id INT DEFAULT NULL, author_id INT NOT NULL, content LONGTEXT NOT NULL, likes INT NOT NULL, reported TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9474526C8A0E4E7F (reply_id), INDEX IDX_9474526CAA5D4036 (story_id), INDEX IDX_9474526CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contribution (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, story_id INT DEFAULT NULL, content LONGTEXT NOT NULL, position INT NOT NULL, reported TINYINT(1) NOT NULL, likes INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_EA351E15F675F31B (author_id), INDEX IDX_EA351E15AA5D4036 (story_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
